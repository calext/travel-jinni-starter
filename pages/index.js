...
export default function Home() {
    return (
        <div lang="en" className={styles.container}>
            ...
            <div className="flex md:flex-row flex-col  md:justify-between w-11/12 m-auto pb-1 pt-2">
                <div>
            ...
            <div className="flex flex-col-reverse md:flex-row items-center md:items-start px-5 sm:px-14 py-4">
                <div className="w-full md:w-60  my-8 md:mt-0">
                    <h1 className="font-bold text-xl font-serif py-1 text-center md:text-left">Six Days In Dubai</h1>
                ...
                <div className="w-full md:w-3/5 max-w-md md:ml-40">
                    <div className="flex flex-col md:flex-row items-center pt-16">
                        <div className="rounded-full w-20 h-20 p-2 mb-5 md:mb-2 flex items-center justify-center bg-white">
                            <img alt="Hillton logo" src="/logo.png" className="h-18 w-18 ml-1 rounded-full" />
                        </div>
                        <div className="md:ml-4 flex-grow text-center border border-white">
                            <h1 className="text-3xl px-1 md:text-3xl lg:text-5xl font-bold font-mono tracking-wide py-2">HILTON HOTEL</h1>
                            <h2 className="bg-white text-black text-base md:text-sm lg:text-lg font-medium font-serif py-2 px-1">POWERED BY TRAVEL JINNI</h2>
                        </div>
                    </div>
                    <div className="w-full  mx-auto text-center border-white border mt-2 pt-8 px-4 bg-gray-400 bg-opacity-10 blur-filter rounded-md">
                        <h1 className="text-2xl lg:text-5xl font-serif font-bold pb-5 px-4">Your Trip Awaits You!</h1>
            ...
            <div className="h-28 w-full bg-red-800  opacity-50 md:absolute left-0 bottom-0">
